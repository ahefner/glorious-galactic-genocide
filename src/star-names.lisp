...
(defun planet-type-blurb (planet-type)
  (ecase planet-type
    ...
    (radiated (format nil "In a tight orbit, this planet basks in extreme solar radiation. Any atmosphere boiled away long ago, leaving a scalding, cratered rock to race around the sun. Peak daytime temperatures are hot enough to melt metals, while at night the temperature may fall below -180~CC. Solar flare activity threatens to periodically scorch the surface of the planet. Establishing any permanent structure in such an environment poses extreme technological challenges." (degrees-char)))))
